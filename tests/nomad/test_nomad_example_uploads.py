...
from pynxtools_microstructure.nomad.example_uploads import microstructure_example_upload
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            microstructure_example_upload,
            EXAMPLE_PATH,
            id="microstructure_example_upload",
        ),
    ],
)
