...
- how to install `pynxtools-microstructure`
- how to install `pynxtools-microstructure` together with NOMAD
...
=== "pip"
    ...
    ```bash
    pip install pynxtools-microstructure
    ```
...
=== "uv"
    ...
    ```bash
    uv pip install git+https://github.com/FAIRmat-NFDI/pynxtools-microstructure.git
    ```

=== "pip"

    ```bash
    pip install git+https://github.com/FAIRmat-NFDI/pynxtools-microstructure.git
    ```

### How to install `pynxtools-microstructure` with NOMAD

To use `pynxtools-microstructure` with NOMAD, simply install it in the same environment as the `nomad-lab` package. NOMAD will recognize `pynxtools-microstructure` as a plugin automatically. In addition, NOMAD will install a schema for NeXus application definitions.

## Start using `pynxtools-microstructure`

That's it! You can now use `pynxtools-microstructure`!
