...
from pynxtools_microstructure.examples.oasisb.oasisb_eln import (
    generate_oasis_specific_yaml,
)
...
def process_project(
    ...
    config: dict[str, str] = {
        ...
        "pynxtools_microstructure_version": f"{get_pynxtools_microstructure_version()}",
    }
